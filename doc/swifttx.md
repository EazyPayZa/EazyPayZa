...
* WebSocket: [https://github.com/eazypayzaproject/insight-api-eazypayza#web-socket-api](https://github.com/eazypayzaproject/insight-api-eazypayza#web-socket-api) 
* API: [https://github.com/eazypayzaproject/insight-api-eazypayza#swifttx-transactions](https://github.com/eazypayzaproject/insight-api-eazypayza#swifttx-transactions) 
...
By default, the EazyPayZa Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EazyPayZa Core daemon:
