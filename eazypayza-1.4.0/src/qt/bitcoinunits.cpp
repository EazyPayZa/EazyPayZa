...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(EZPAY);
    unitlist.append(mEZPAY);
    unitlist.append(uEZPAY);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case EZPAY:
        return QString("eazypayza");
    case mEZPAY:
        return QString("meazypayza");
    case uEZPAY:
        return QString::fromUtf8("ueazypayza");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case EZPAY:
            return QString("EZPAY");
        case mEZPAY:
            return QString("mEZPAY");
        case uEZPAY:
            return QString::fromUtf8("μEZPAY");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case EZPAY:
            return QString("tEZPAY");
        case mEZPAY:
            return QString("mtEZPAY");
        case uEZPAY:
            return QString::fromUtf8("μtEZPAY");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case EZPAY:
            return QString("EZPAY");
        case mEZPAY:
            return QString("Milli-EZPAY (1 / 1" THIN_SP_UTF8 "000)");
        case uEZPAY:
            return QString("Micro-EZPAY (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case EZPAY:
            return QString("TestEZPAYs");
        case mEZPAY:
            return QString("Milli-TestEZPAY (1 / 1" THIN_SP_UTF8 "000)");
        case uEZPAY:
            return QString("Micro-TestEZPAY (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
