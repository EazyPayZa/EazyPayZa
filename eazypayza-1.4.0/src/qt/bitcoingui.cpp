                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EazyPayZa Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EazyPayZa address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eazypayza: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEZPAY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EazyPayZa Core"), this);
    aboutAction->setStatusTip(tr("Show information about EazyPayZa Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EazyPayZa"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EazyPayZa addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EazyPayZa addresses"));
    ...
    openAction->setStatusTip(tr("Open a EazyPayZa: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EazyPayZa Core help message to get a list with possible EazyPayZa command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EazyPayZa Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EazyPayZa network", "", count));
}
...
{
    QString strTitle = tr("EazyPayZa Core"); // default title
