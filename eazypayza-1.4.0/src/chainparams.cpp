...
public:
    CMainParams()
    {
        ...
        nEnforceBlockUpgradeMajority = 999999999;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60;
        nTargetSpacing = 2 * 60;  // EazyPayZa: 2 minutes
        nMaturity = 100;
        ...
        const char* pszTimestamp = "EazyPayZa  new blockchain for swap  06 Jan 2020 - Remapper";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1579201348;
        genesis.nBits = 0x1e0ffff0; // 504365040
        genesis.nNonce = 203219;
        ...
        if (regenerate) {
            ...
            assert(hashGenesisBlock == uint256("0x00000661208f4530c1a9e0824cd5ff6d1ce4c66e2d5a244ba73d0f784d95b93e"));
            assert(genesis.hashMerkleRoot == uint256("0xe04ae41c68cd6f25b497465ae55fe9e4848df78e8ac2292480c1cc1267b36902"));
        }
		...
		vSeeds.push_back(CDNSSeedData("1", "156.96.46.60"));     //Team 1
		vSeeds.push_back(CDNSSeedData("2", "156.96.46.61"));     //Team 2
		vSeeds.push_back(CDNSSeedData("3", "156.96.46.62"));     //Team 3
		vSeeds.push_back(CDNSSeedData("4", "156.96.46.63"));     //Team 4
		vSeeds.push_back(CDNSSeedData("5", "104.238.135.93")); //Remapper 1
		vSeeds.push_back(CDNSSeedData("6", "8.9.3.101"));          //Remapper 2
        ...
        strObfuscationPoolDummyAddress = "JYw365YSYahSDbhvWLN8NYwP9RPxZPDStB";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // EazyPayZa: 1 day
        nTargetSpacing = 1 * 10;  // EazyPayZa: 1 minute
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet eazypayza addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet eazypayza script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet eazypayza BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet eazypayza BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet eazypayza BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EazyPayZa: 1 day
        nTargetSpacing = 1 * 60;        // EazyPayZa: 1 minutes
