...
#ifndef EAZYPAYZA_ZEZPAYWALLET_H
#define EAZYPAYZA_ZEZPAYWALLET_H
...
public:
    CzEZPAYWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEZPAY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEZPAY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //EAZYPAYZA_ZEZPAYWALLET_H
