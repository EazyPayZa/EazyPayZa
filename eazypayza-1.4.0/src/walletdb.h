...
public:
    ...
    bool WriteZEZPAYSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZEZPAYSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZEZPAYSeed_deprecated(uint256& seed);
    bool EraseZEZPAYSeed();
    bool EraseZEZPAYSeed_deprecated();

    bool WriteZEZPAYCount(const uint32_t& nCount);
    bool ReadZEZPAYCount(uint32_t& nCount);
