...
#ifndef EAZYPAYZA_ZEZPAYTRACKER_H
#define EAZYPAYZA_ZEZPAYTRACKER_H
...
public:
    CzEZPAYTracker(std::string strWalletFile);
    ~CzEZPAYTracker();
...
#endif //EAZYPAYZA_ZEZPAYTRACKER_H
