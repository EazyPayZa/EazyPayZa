...
/** Utility functions used by the EazyPayZa Qt UI.
 */
namespace GUIUtil
{
...
// Render EazyPayZa addresses in monospace font
...
// Parse "eazypayza:" URI into recipient object, return true on successful parsing
