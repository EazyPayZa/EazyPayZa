...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop EazyPayZa server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "EazyPayZa server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EazyPayZa features */
        {"eazypayza", "masternode", &masternode, true, true, false},
        {"eazypayza", "listmasternodes", &listmasternodes, true, true, false},
        {"eazypayza", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eazypayza", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eazypayza", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"eazypayza", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eazypayza", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eazypayza", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eazypayza", "masternodedebug", &masternodedebug, true, true, false},
        {"eazypayza", "startmasternode", &startmasternode, true, true, false},
        {"eazypayza", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eazypayza", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eazypayza", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eazypayza", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eazypayza", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eazypayza", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eazypayza", "mnbudget", &mnbudget, true, true, false},
        {"eazypayza", "preparebudget", &preparebudget, true, true, false},
        {"eazypayza", "submitbudget", &submitbudget, true, true, false},
        {"eazypayza", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eazypayza", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eazypayza", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eazypayza", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eazypayza", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eazypayza", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eazypayza", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eazypayza", "checkbudgets", &checkbudgets, true, true, false},
        {"eazypayza", "mnsync", &mnsync, true, true, false},
        {"eazypayza", "spork", &spork, true, true, false},
        {"eazypayza", "getpoolinfo", &getpoolinfo, true, true, false},
        {"eazypayza", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> eazypayza-cli " + methodname + " " + args + "\n";
}
