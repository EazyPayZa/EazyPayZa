...
bool IsBudgetCollateralValid(uint256 nTxCollateralHash, uint256 nExpectedHash, std::string& strError, int64_t& nTime, int& nConf, bool fBudgetFinalization)
{
    ...
    BOOST_FOREACH (const CTxOut o, txCollateral.vout) {
        ...
        if (fBudgetFinalization) {
            ...
            // Note: there are still old valid budgets out there, but the check for the new 25 EZPAY finalization collateral
            //       will also cover the old 50 EZPAY finalization collateral.
...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
	...
	if (nHeight == 0) {
        ...
        nSubsidy = 6.666 * COIN;
    } else if (nHeight > 200 && nHeight <= 525600) {
        nSubsidy = 6.666 * COIN;
        ...
        nSubsidy = 2 * COIN;
	} else if (nHeight > 2102400 && nHeight <= 4204800) {
        nSubsidy = 1.334 * COIN;
	} else if (nHeight > 4204800 && nHeight <= 6307200) {
        nSubsidy = 1.09 * COIN;
	} else if (nHeight > 6307200 && nHeight <= 8409600) {
        nSubsidy = 0.891 * COIN;
	} else if (nHeight > 8409600 && nHeight <= 10512000) {
        nSubsidy = 0.729 * COIN;
	} else if (nHeight > 10512000 && nHeight <= 12614400) {
        nSubsidy = 0.596 * COIN;
	} else if (nHeight > 12614400 && nHeight <= 14716800) {
        nSubsidy = 0.487 * COIN;
	} else if (nHeight > 14716800 && nHeight <= 16819200) {
        nSubsidy = 0.398 * COIN;
	} else if (nHeight > 16819200 && nHeight <= 18921600) {
        nSubsidy = 0.325 * COIN;
	} else if (nHeight > 18921600 && nHeight <= 21024000) {
        nSubsidy = 0.266 * COIN;
	} else if (nHeight > 21024000 && nHeight <= 23126400) {
        nSubsidy = 0.217 * COIN;
	} else if (nHeight > 23126400 && nHeight <= 25228800) {
        nSubsidy = 0.178 * COIN;
	} else if (nHeight > 25228800 && nHeight <= 27331200) {
        nSubsidy = 0.145 * COIN;
	} else if (nHeight > 27331200 && nHeight <= 29433600) {
        nSubsidy = 0.112 * COIN;
	} else if (nHeight > 29433600 && nHeight <= 31536000) {
        nSubsidy = 0.097 * COIN;
	} else if (nHeight > 31536000 && nHeight <= 33638400) {
        nSubsidy = 0.079 * COIN;
	} else if (nHeight > 33638400 && nHeight <= 35740800) {
        nSubsidy = 0.065 * COIN;
	} else if (nHeight > 35740800 && nHeight <= 37843200) {
        nSubsidy = 0.054 * COIN;
	} else if (nHeight > 37843200 && nHeight <= 39945600) {
        nSubsidy = 0.044 * COIN;
	} else if (nHeight > 39945600 && nHeight <= 42048000) {
        nSubsidy = 0.035 * COIN;
	} else if (nHeight > 42048000 && nHeight <= 44150401) {
        nSubsidy = 0.03 * COIN;
	} else if (nHeight > 44150401 && nHeight <= 46252800) {
        nSubsidy = 0.025 * COIN;
	} else if (nHeight > 46252800 && nHeight <= 48355200) {
        nSubsidy = 0.02 * COIN;
	} else if (nHeight > 48355200 && nHeight <= 50457600) {
        nSubsidy = 0.017 * COIN;
	} else if (nHeight > 50457600 && nHeight <= 52560000) {
        nSubsidy = 0.012 * COIN;
	} else {
        nSubsidy = 0.001 * COIN;
    }

	//Start budget payment only after POW ended
	if (nHeight > 200) {
